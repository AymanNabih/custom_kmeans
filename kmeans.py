...
Description: Implementation of KMeans clustering with
            a distance measure of your choosing.
            Modelled after the implementation by
            sklearn.
"""
...
class KMeans():
    ...
    def fit(self, X):
        ...
        Arguments
            X <2d array>:   Matrix of datapoints to cluster, where each row
                            is a datapoint, and each column is a feature
        Returns
            self
        """
    ...
    def fit_predict(self, X):
        ...
        Returns
            self.labels <list>: The cluster number assigned to each datapoint.
